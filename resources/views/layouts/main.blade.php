        ...
        <div class="menu">
            ...
            <div class="body">
                <div class="list-group">
                    ...
                    <a href="{{ route('premios') }}" class="list-group-item list-group-item-action">PRÊMIOS</a>
                    <a href="http://app.gmbrasilvd.com.br/" class="list-group-item list-group-item-action">ESCRITÓRIO
                        VIRTUAL</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark">
                    ...
                    <div class="collapse navbar-collapse menu-desk" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('bonus') }}">BÔNUS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('premios') }}">PRÊMIOS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="http://app.gmbrasilvd.com.br/">ESCRITÓRIO
                                    VIRTUAL</a>
                            </li>
                            <li class="nav-item">
